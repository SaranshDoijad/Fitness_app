...
public class ThirdActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonvalue2 =intent.getStringExtra("value");

        int intvalue2=Integer.parseInt(buttonvalue2);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(status == false) {
                    status = true;
                    b3.setImageResource(R.drawable.buttun_volume_up);
                    ...
                    tts.shutdown();
                    b3.setImageResource(R.drawable.baseline_volume_off_24);
                    status = false;
